...
<section class="section">
    <div class="section-header">
        ...
        <div class="section-header-breadcrumb">
            <div class="breadcrumb-item active"><a href="{{route('disposisi_surat_masuk.index')}}">Disposisi Surat Masuk</a></div>
        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card shadow ">
                    ...
                    <div class="card-body">
                        <form action="{{route('disposisi-surat-masuk-teruskan.store')}}" method="POST" >
                            @csrf
                            ...
                            <a href="{{ route('disposisi_surat_masuk.index') }}" class="btn btn-warning">
