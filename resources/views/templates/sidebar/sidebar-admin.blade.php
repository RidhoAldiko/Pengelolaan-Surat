...
<aside id="sidebar-wrapper">
    ...
    <ul class="sidebar-menu">
        ...
        <li class="menu-header">Master Data</li>
            ...
            <ul class="dropdown-menu">
                <li class="{{ set_active(['data-gaji.index','data-golongan.index','data-golongan.create','data-golongan.edit']) }}"><a class="nav-link" href="{{ route('data-golongan.index') }}">Golongan</a></li>
                ...
                <li class="{{ set_active(['data-gaji.index']) }}"><a class="nav-link" href="{{ route('data-gaji.index') }}">Gaji</a></li>    
            </ul>
    </ul>
</aside>
</div>